...
Ensure you have installed [node package manager][npm].  You can test to see if it's installed like this:
```
npm --version
```
...
```
git clone git@github.com:sfncook/ictracker_angular_2.git
cd ictracker_angular_2
```

Prepare the dependant packages:
